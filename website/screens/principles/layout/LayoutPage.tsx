          ...
          content: (
            <>
              <DxcText as="p">
                ...
                devices. We've defined five different breakpoints to accommodate
                multiple web, tablet, and mobile screen resolutions:
              </DxcText>
              <DxcTable>
                <thead>
                  <tr>
          ...
          content: (
            <>
              ...
              <DxcText as="p">
                ...
                size of a device, column numbers and the values of the margins
                and gutters adjust to accommodate all screen elements in the
                most optimal manner.
              </DxcText>
              <DxcList>
                <DxcText>
