...
export const componentTokens = {
  ...
  text: {
    defaultColor: globalTokens.color_black,
    errorColor: globalTokens.hal_red_s_41,
    successColor: globalTokens.hal_green_s_39,
    infoColor: globalTokens.hal_blue_l_45,
    warningColor: globalTokens.hal_yellow_d_40,
  },
  textarea: {
    fontFamily: globalTokens.type_sans,
    enabledBorderColor: globalTokens.hal_black,
