...
const section = {
  ...
  content: (
    <>
      <DxcText as="p">
        In the search of consistent alignment between the elements we provide a
        spacing scale based on a root values of 8px and 4px. The numbers 4 and 8
        are easily multiplied, they provide flexible and consistent, yet
          ...
          content: (
            <>
              <DxcText as="p">
                ...
                divide a page or to control a component <Code>max-width</Code>{" "}
                and <Code>min-width</Code>. Using percentages for top and bottom
                values of <Code>padding</Code> or <Code>margin</Code> inside of
                a component or element should be avoided.
              </DxcText>
            </>
          ),
        },
