import { DxcText, DxcTable } from "@dxc-technology/halstack-react";
        ...
        subSections: [
            ...
            content: (
              <>
                <DxcText as="p">
                  ...
                  vertical spacing, it can also be applied for horizontal
                  spacing, especially in the case of spacing inside components.
                </DxcText>
                <Figure
                  caption={
                    <>
                      <DxcText as="p">
                        <strong>Left</strong>: Horizontal: Used for smaller,
                        more refined spacing needs, inside components.
                      </DxcText>
                      <DxcText as="p">
          ...
          },
          {
            ...
            content: (
              <>
                <DxcText as="p">
                  The use of percentages (e.g. 50% or 33%) is a recommended way
                  to divide a page or to control a component{" "}
                  <Code>max-width</Code> and <Code>min-width</Code>. Using
                  percentages for top and bottom values of <Code>padding</Code>{" "}
                  or <Code>margin</Code> inside of a component or element should
                  be avoided.
                </DxcText>
              </>
            ),
              ...
              caption={
                <>
                  <DxcText as="p">
                    ...
                    <Code>top</Code> <Code>padding</Code> properties.
                  </DxcText>
                </>
              }
            >
...
const Spacing = () => {
  return (
    <DocumentationContainer
      ...
      sections={sections}
      githubLink={
        "https://github.com/dxc-technology/halstack-style-guide/blob/master/website/screens/principles/spacing/SpacingPage.tsx"
      }
    ></DocumentationContainer>
  );
};
