      ...
      content: (
        <>
          ...
          <DxcText as="p">
            ...
            The chevron icon at the end of the accordion indicates which state
            the accordion is in. Accordions begin by default in the collapsed
            state with all content panels closed. Starting in a collapsed state
            gives the user a high level overview of the available information.
          </DxcText>
          <DxcList>
            <DxcText>
...
const AccordionUsagePage = () => {
  return (
    <DocumentationContainer
      section={section}
      githubLink={
        "https://github.com/dxc-technology/halstack-style-guide/blob/master/website/screens/components/accordion/usage/AccordionUsagePage.tsx"
      }
    ></DocumentationContainer>
  );
};
