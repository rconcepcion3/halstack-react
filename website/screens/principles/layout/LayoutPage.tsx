        ...
        content: (
          <>
            ...
            <DxcText as="p">
              ...
              used within each other to create a wide variety of standard
              layouts:
            </DxcText>
            <DxcList>
              <DxcText>
        ...
        subSections: [
            ...
            content: (
              <>
                <DxcText as="p">
                  ...
                  all the visual elements of Halstack Design System components
                  and spacing. It provides structure and guidance for all
            ...
            subSections: [
              {
                ...
                content: (
                  <DxcList>
                    <DxcText>
                      Use multiples of 8px when defining measurements, spacing,
                      and positioning elements.
                    </DxcText>
                    <DxcText>
                      When necessary use 4px to make more fine tuned
                      adjustments.
                    </DxcText>
                    <DxcText>
                    ...
                    <DxcText>
                      Align your bounding box to the grid, not the baseline of
                      your text.
                    </DxcText>
                  </DxcList>
                ),
          ...
          },
          {
            ...
            content: (
              <>
                <DxcText as="p">
                  Breakpoints define resolutions at which screen components
                  adjust to offer an optimal user experience across screen sizes
                  and devices. We've defined five different breakpoints to
                  accommodate multiple web, tablet, and mobile screen
                  resolutions:
                </DxcText>
                <DxcTable>
                  <thead>
                ...
                <DxcText as="p">
                  ...
                  popular screen resolutions by device over the past few years
                  to help define each breakpoint.
                </DxcText>
          ...
          },
          {
            ...
            content: (
              <>
                ...
                <DxcText as="p">
                  Columns, gutters, and margins make up the responsive layout
                  grid following these breakpoints. Depending on resolution and
                  screen size of a device, column numbers and the values of the
                  margins and gutters adjust to accommodate all screen elements
                ...
                <DxcList>
                  ...
                  <DxcText>
                    A gutter is the space between columns used to separate
                    content.{" "}
                  </DxcText>
                  <DxcText>
            ...
            subSections: [
              {
                ...
                content: (
                  <>
                    <DxcText as="p">
                      The following table describes the columns, margins, and
                      gutter at each of the different breakpoints:
                    </DxcText>
                    <DxcTable>
                      <thead>
                        <tr>
                    ...
                    <DxcList type="number">
                      <DxcText>
                        Any value provided by the <Code>gutter</Code> prop in
                        the layout components can be used (ideally multiples of
                        8) although we recommend to stick to the values
                        provided.{" "}
                      </DxcText>
                      <DxcText>
                        The margin value provided are the minimun recommended,
                        any value from our{" "}
                        <DxcLink
...
const Layout = () => {
  return (
    <DocumentationContainer
      ...
      sections={sections}
      githubLink={
        "https://github.com/dxc-technology/halstack-style-guide/blob/master/website/screens/principles/layout/LayoutPage.tsx"
      }
    ></DocumentationContainer>
  );
};
