import { DxcText, DxcList, DxcLink } from "@dxc-technology/halstack-react";
import DocumentationContainer from "../../common/DocumentationContainer";

const title = "Halstack Design System";
const sections = [
  {
    title: title,
    content: (
        ...
        content: (
          <>
            <DxcText as="p">
              ...
              Technology&#39;s approach to provide guidance for development
              teams in order to deliver delightful and consistent user
            ...
            <DxcText as="p">
              ...
              objective of creating a unique visual language and ecosystem for
              our applications. This is the DXC way of creating User
              Experiences.
            </DxcText>
          </>
        ),
        ...
        content: (
          <>
            <DxcText as="p">
              ...
              towards DXC Technology bussines needs, but it is open for anyone
              to use and contribute back to.
            </DxcText>
            <DxcText as="p">
        ...
        subSections: [
          {
            ...
            content: (
              <DxcText as="p">
                ...
                quickly create solutions four our clients. Helping them focusing
...
const Introduction = () => {
  return (
    <DocumentationContainer
      ...
      sections={sections}
      githubLink={
        "https://github.com/dxc-technology/halstack-style-guide/blob/master/website/screens/overview/introduction/IntroductionPage.tsx"
      }
    ></DocumentationContainer>
  );
};
