import { DxcText, DxcTable, DxcLink } from "@dxc-technology/halstack-react";
...
const section = {
  ...
  content: (
    <>
      ...
      <DxcText as="p">
        <strong>
          The color palette is an essential asset as a communication resource of
          our design system.
        </strong>
      </DxcText>
      <DxcText as="p">
        Halstack color palette brings a unified consistency and helps in guiding
        the user&#39;s perception order. Our color palette is based in the{" "}
        <DxcLink
          ...
          newWindow
        />
        . All our color families are calculated using the lightness value of the
        standard DXC palette colors.
      </DxcText>
    </>
  ),
  subSections: [
    {
      ...
      content: (
        <DxcText as="p">
          ...
          our set of components. Additional families as red, green and yellow
...
const Color = () => {
  return (
    <DocumentationContainer
      section={section}
      githubLink={
        "https://github.com/dxc-technology/halstack-style-guide/blob/master/website/screens/principles/color/ColorPage.tsx"
      }
    ></DocumentationContainer>
  );
};
